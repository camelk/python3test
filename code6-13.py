...
def printMonthBody (year, month):
	...
	# Insert the blank in front of the first day of the month
	i = 0
...
def main():
	year = eval(input("Enter a year.(ex 2001): "))
